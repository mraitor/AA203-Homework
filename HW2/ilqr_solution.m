...
while norm(u_bar - u_bar_prev) > epsilon
    ...
    for t=1:num_steps
        ...
        u_bar(:,t) = u_bar_prev(:,t) + l(:,t) + L(:,:,t)*(dx);% TODO: implement control update
        x_bar(:,t+1) = f(x_bar(:,t),u_bar(:,t),dt);
    end
...
%Calc l and L
l = -inv(Q_tilde_uu)*Q_tilde_u;
L = -inv(Q_tilde_uu)*Q_tilde_ux;

%calc value function
p = Q_tilde_x - L'*Q_tilde_uu*l;
P = Q_tilde_xx - L'*Q_tilde_uu*L;
end